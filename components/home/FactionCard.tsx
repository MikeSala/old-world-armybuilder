  ...
  return (
    <Link
      ...
      className="group relative flex flex-none snap-start items-center justify-center p-4
                 ...
                 hover:bg-slate-900/80 hover:shadow-xs
    ...
    >
      {/* Icon container */}
      <div
        className="absolute left-1/2 top-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 -mt-[10px] items-center justify-center rounded-full
      ...
      >
        <Icon className="h-6 w-6 transition-colors duration-300" style={{ color: theme.primary }} />
      </div>

      {/* Faction name */}
      <h3
        className="absolute left-3 right-3 top-[110px] text-xs font-semibold uppercase tracking-wide text-amber-100/90
