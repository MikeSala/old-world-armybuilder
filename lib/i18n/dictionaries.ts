...
const dictionaries = {
  pl: {
    ...
    categoryCorePointsSummary: "{current} pkt / min {required} pkt",
    categoryCapPointsSummary: "{current} pkt / max {limit} pkt",
    ...
    landingSeoTitle:
      "Army Builder – Darmowy kreator armii Warhammer: The Old World",
  ...
  en: {
    ...
    editMoveToTopLabel: "Back to top",
    ...
    categoryCorePointsSummary: "{current} pts / min {required} pts",
    categoryCapPointsSummary: "{current} pts / max {limit} pts",
    ...
    landingSeoTitle:
      "Army Builder – Free Warhammer: The Old World Army Creator",
  ...
  de: {
    ...
    categoryConfirmAddLabel: "Hinzufügen",
    ...
    landingSeoTitle:
      "Army Builder – Kostenloser Armeeplaner für Warhammer: The Old World",
  ...
  fr: {
    ...
    categoryConfirmAddLabel: "Ajouter",
    ...
    landingSeoTitle:
      "Army Builder – Créateur d'armée gratuit pour Warhammer: The Old World",
    landingSeoLabel: "Description :",
    landingSeoIntro:
  ...
  es: {
    ...
    categoryCorePointsSummary: "{current} pts / mín {required} pts",
    categoryCapPointsSummary: "{current} pts / máx {limit} pts",
    ...
    categoryConfirmAddLabel: "Añadir",
    ...
    landingSeoTitle:
      "Army Builder – Creador de ejércitos gratuito para Warhammer: The Old World",
