...
const PHRASE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bChosen Chaos Knights\b/gi, "Wybrani Rycerze Chaosu"],
  [/\bChaos Knights\b/gi, "Rycerze Chaosu"],
  [/\bChaos Knight\b/gi, "Rycerz Chaosu"],
  [/\bChaos Marauders\b/gi, "Maruderzy Chaosu"],
  [/\bChaos Marauder\b/gi, "Marauder Chaosu"],
  [/\bDragon Ogre Shaggoth\b/gi, "Shaggoth Smoczy Ogr"],
  [/\bDragon Ogres\b/gi, "Smocze Ogry"],
  [/\bDragon Ogre\b/gi, "Smoczy Ogr"],
  [/\bDragon Princes of Caledor\b/gi, "Smocze Książęta z Caledoru"],
  [/\bDragon Prince\b/gi, "Smocze Książę"],
  [/\bDragon Mage\b/gi, "Smoczy Mag"],
  [/\bDragon Slayer\b/gi, "Smobójca"],
  [/\bDragon Slayers\b/gi, "Smobójcy"],
  [/\bBlack Dragon\b/gi, "Czarny Smok"],
  [/\bCelestial Dragon Guard\b/gi, "Niebiańska Smocza Gwardia"],
